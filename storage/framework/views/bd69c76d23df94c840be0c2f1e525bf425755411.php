    ...
    <script>
        (function(){
            ...
            card.addEventListener('change', function(event) {
              ...
              if (event.error) {
                displayError.textContent = event.error.message+"2";
              } else {
            ...
            form.addEventListener('submit', function(event) {
              ...
              var options = {
                ...
                address_line2: document.getElementById('address').value,
              ...
              stripe.createToken(card, options).then(function(result) {
                if (result.error) {
                  ...
                  errorElement.textContent = result.error.message+"1";
                    console.log(options);
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mojtaba/laraval-project/laravel-ecommerce-example/resources/views/checkout.blade.php ENDPATH**/ ?>